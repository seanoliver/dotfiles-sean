# Generated by Powerlevel10k configuration wizard on 2023-10-06 at 10:05 PDT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 40544.
# Wizard options: powerline, rainbow, ascii, 12h time, 1 line, sparse, fluent,
...
typeset -g POWERLEVEL9K_DIR_BACKGROUND=8      # Blue background
typeset -g POWERLEVEL9K_DIR_FOREGROUND=255    # White text

# Customize git status colors
typeset -g POWERLEVEL9K_VCS_BACKGROUND=2      # Green background
typeset -g POWERLEVEL9K_VCS_FOREGROUND=0      # Black text

# Customize the prompt for the username and hostname
typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=3  # Yellow background
typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=0  # Black text

# Customize the Python virtual environment segment
typeset -g POWERLEVEL9K_PYENV_BACKGROUND=5    # Magenta background
typeset -g POWERLEVEL9K_PYENV_FOREGROUND=255  # White text
