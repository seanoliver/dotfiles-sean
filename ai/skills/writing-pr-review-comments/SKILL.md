...
- **2 to 5 short sentences.** Rarely more.
...
The "✅" version trusts the reader to know how TS narrowing works. It also drops "repeated four times", which is visible in the diff.
...
7. Sentence count check: 2 to 5. If over, trim.
8. Paste.
